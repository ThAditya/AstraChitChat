...
class _CreateCommunityScreenState extends ConsumerState<CreateCommunityScreen> {
  ...
  void _createCommunity() {
    ...
    // Redirect to list
    context.pushReplacement('/communities-list');
  }
              ...
              children: [
                  ...
                  child: Stack(
                    children: [
                      CircleAvatar(
                        ...
                        child: Icon(Iconsax.colors_square_copy, color: AppColors.textGrey, size: 30.sp),
                      ),
                      Positioned(
                        bottom: 0,
                        right: 0,
                        child: Container(
                          ...
                          decoration: const BoxDecoration(color: AppColors.secondaryNeon, shape: BoxShape.circle),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: const UnderlineInputBorder(borderSide: BorderSide(color: AppColors.secondaryNeon)),
                  ),
                ),
